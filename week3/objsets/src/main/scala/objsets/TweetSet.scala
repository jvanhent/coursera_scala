...
abstract class TweetSet {
   ...
   */
    ...
    def mostRetweetedSearch(t: Tweet) : Tweet
...
class Empty extends TweetSet {
  ...
  def mostRetweetedSearch(t: Tweet) : Tweet = t
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = mostRetweetedSearch(elem)
  def mostRetweetedSearch(t: Tweet) : Tweet = {
    val leftMost = left.mostRetweetedSearch(t)
    val rightMost = right.mostRetweetedSearch(leftMost)
